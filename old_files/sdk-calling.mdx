...
Before we begin it's important to ensure that a contract is compatible with Relay. Please review our [Contract Compatibility](/references/api/api_core_concepts/contract-compatibility) overview to make any necessary changes.
...
<Note>
  Quotes can go stale after 30 seconds. Clients should regularly fetch fresh quotes so that users are always submitting valid transactions. [Learn more](/how-it-works/the-relay-solver#getting-a-quote) about Relay quotes.
</Note>
