...
**Note** - Quotes can go stale after 30 seconds. Clients should regularly fetch fresh quotes so that users are always submitting valid transactions. [Learn more](/how-it-works/the-relay-solver#getting-a-quote) about Relay quotes.
...
☐ Verify that the user has enough balance on the origin chain to cover the full bridge amount \+ fees. Check out our [fees](/how-it-works/fees) doc for more details on calculating the fees.
