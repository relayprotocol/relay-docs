...
Relay is multichain payments infrastructure, designed to make swapping and transacting across 100s of chains delightfully simple. Since launching in 2024, Relay has supported **5M users**, enabled **50M transactions**, and driven **$5B+ in volume** across **85+ networks**.

It combines two core components:

- Instant low cost crosschain intents, powered by the [Relay Protocol](/references/protocol/overview)
...
<Columns cols={3}>
  ...
  <Card
    ...
    cta="Learn More"
  >
    Same-chain & Crosschain Swaps on Every Chain
  </Card>
  <Card
...
Built as a full-stack solution for every layer of the multichain experience:
...
- **Deliver reliable UX** with gas sponsorship, guaranteed rates, and SLAs

Whether you're building wallets, marketplaces, or consumer apps, Relay makes crosschain transactions fast, reliable, and invisible.

[View Documentation](/references/api/overview)

### Relay Protocol

**The infrastructure powering it all** - An open, non-custodial system connecting users to relayers who execute onchain actions with maximum capital efficiency. Designed for low gas costs, rapid chain expansion, and enterprise-grade reliability.
...
Unlike traditional bridges, users experience the reliability they expect from modern infrastructure:
...
**Chain Expansion**: Alchemy, Conduit, and Caldera use Relay as crosschain infrastructure for every rollup out of the box.
...
**For Teams & Developers**: Check out the [Quickstart Guide](/references/api/quickstart) to add multichain support to your app.

---

_Contact the Relay team about enterprise features including dedicated support, custom SLAs, and priority routing._
