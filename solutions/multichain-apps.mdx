...
**App Fees** - Our comprehensive approach to [App Fees](/references/api/api_core_concepts/fees#app-fees) lets you easily earn when using Relay. Additionally, we have designed our fee system for you to automatically collect fees in stables (USDC).
