...
Relay is designed to make transacting across chains as fast, cheap, and reliable as online payments. If you are a mulitchain app, there are several key ways to use Relay.
...
**[In App Swaps & Bridging](/use-cases/cross-chain-swaps)** - Relay's [Any-to-Any Swaps]() allows apps to embed bridging and swaps. We couple instant cross-chain routing via the Relay Network with meta-aggregation of the best onchain swap providers to give your users great prices, instant exchange across chains, and quick quotes.
