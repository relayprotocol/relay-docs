---
title: "Chains"
description: "Connect your chain to users and balances across the onchain economy"
---

Let users reach your chain with the assets they already hold elsewhere. Once your chain is supported, developers can add swaps, payments, and cross-chain actions through the Relay APIs:

**[Instant Onboarding](/use-cases/bridging)** - Let users fund accounts on your chain from supported assets and networks. Build your own onboarding experience with the API or embed [RelayKit UI components](/references/relay-kit/overview).
