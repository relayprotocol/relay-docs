...
[Deposit addresses](/features/deposit-addresses) - Depsoit addresses let users initiate Relays without connecting a wallet or from a surface that doesn't allow it, such as a centralized Exchange. Deposit addresses are static addresses route and convert to your settlement asset automatically when funds enter the address. This is particularly valuable for centralized exchange payments.
