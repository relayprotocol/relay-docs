...
description: "Accept and disburse any asset, on any supported chain, settled in the currency you run on"
---

Let customers pay from the chains they use and receive funds in the asset your business runs on. Add onchain acceptance and payouts across supported assets and networks with one [Relay](/what-is-relay) integration.
...
The platform screens transaction addresses using blockchain-analytics providers and an internal blocklist. Screening covers sender, recipient, and fee recipient addresses, plus the depositing wallet on deposit-address flows. A match can block a quote or fill; see [Transaction Screening](/security/compliance) for details and review paths.
