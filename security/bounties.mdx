...
As a rough intuition: critical bugs usually pay **$20k–$100k**, high bugs **$7.5k–$30k**, and most modifier-adjusted payouts land at **30–70% of base**.
...
<Info>The **permanently unrecoverable** modifier applies to freeze scenarios only. S3 and S4 already encode "no time to react" for theft-class bugs, so ×1.5 would double-count there.</Info>
...
- **"The attacker would need to be a solver or relayer."** Permissioned roles are L1, not L2. L2 is reserved for open-market conditions (flash loans, MEV).
