...
* __currentStep__: The current step that's being processed, made conveniently accessible in this callback.
* __currentStepItem__: Similarly, the current step item that is being processed, made easily accessible. A step can contain multiple items that are processed in parallel as a batch.
