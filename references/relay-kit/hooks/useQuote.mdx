...
| **wallet**       | A valid [WalletClient](https://viem.sh/docs/clients/wallet) from Viem or an AdaptedWallet generated from an adapter. This parameter can be left empty if just retrieving a quote, but is required for executing a quote. | ❌       |
