...
| ---------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------- |
| **client**       | A RelayClient instance. You can create one using the [SDK](https://docs.relay.link/references/sdk/createClient) or retrieve one using the `useRelayClient` hook from the UI kit.                                                | ✅       |
