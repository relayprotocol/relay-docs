...
| **options**      | Query parameters that map directly to the [currencies api](/references/api/get-currencies-v2)                                                                                                   | ❌       |
...
The hook returns an object with the base [Tanstack Query response](https://tanstack.com/query/v5/docs/framework/react/reference/useQuery). The data property maps to the object returned in the aforementioned [currencies api](/references/api/get-currencies-v2).
