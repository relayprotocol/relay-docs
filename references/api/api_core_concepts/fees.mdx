...
3. **Relay Fees**
   ...
   A flat basis point fee charged for using the Relay API gateway and related services. The fee varies by asset pair type and applies to both cross-chain and same-chain transactions.
4. **App Fees**
