...
2. **Swap Fees**
   ...
   Fees to liquidity providers that enable cross-asset and crosschain token swaps.
   - DEX fees
   - DEX swap impact
   - Solver crosschain rebalancing fees
3. **Relay Fees**
...
If you are interested in learning how app fees work, and how you can add them to your quotes please check out the [App Fees Doc](/features/app-fees).\
\
...
**relayerService**: The service fee paid to the relayer to support execution.
...
**swap** - the price impact that results from cross-asset and crosschain token exchange
