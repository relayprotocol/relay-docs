...
<Note>
In the quote API and [`GET /requests/v2`](/references/api/get-requests), this same breakdown is returned as the `expandedPriceImpact` object, and the **platform** component is named **relay**.
</Note>
