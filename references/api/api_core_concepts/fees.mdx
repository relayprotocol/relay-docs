...
We return two objects from the quote API that are of interest to best understand fees:

## Fees Object

The Fees object returned from the quote API reports the following fees:
