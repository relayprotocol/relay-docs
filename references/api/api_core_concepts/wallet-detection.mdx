...
Protocol v2 uses the Relay Depository contracts to enable trustless crosschain
transactions. For ERC20 token deposits, there are two possible transaction flows:
