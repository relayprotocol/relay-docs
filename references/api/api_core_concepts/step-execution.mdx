...
| Step ID                       | Description                                | When Used                                                                                                                                                                                                      |
| ----------------------------- | ------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [`authorize`](#authorize)     | Sign authorization for specific operations | Used for: (1) Claiming [app fees](/references/api/api_core_concepts/fees#app-fees) - EIP-191 signature to verify wallet ownership, (2) [Hyperliquid](/references/api/api_guides/hyperliquid-support) v2 deposits - nonce-mapping signature. |
