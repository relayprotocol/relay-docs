...
For example, if you deposit 100 USDC that gets swapped to 95 USDC before the bridge fails, your refund will be based on the 95 USDC (minus gas costs), not your original 100 USDC deposit.
