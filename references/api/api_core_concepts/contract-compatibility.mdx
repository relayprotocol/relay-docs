...
This might seem like a lot, but especially when Origin and Destination are both L2s, it can be quite fast and cheap. Arguably, much much better than the user needing to worry about having a balance on many chains.
