...
Relay supports the following Hyperliquid assets:
...
- **Other Spot assets**: Including USDe, USDH, and other tokens returned by the Hyperliquid RPC

For a complete and up-to-date list of supported assets, check the [Chains API](https://docs.relay.link/references/api/get-chains) response for Hyperliquid (chainId: 1337).
...
For a complete implementation example, refer to the [publicly available SDK](https://github.com/reservoirprotocol/relay-kit/blob/main/packages/sdk/src/utils/hyperliquid.ts).