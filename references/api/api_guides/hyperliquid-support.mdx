...
These params define the necessary parameters for Hyperliquid interactions. All other required API parameters are still necessary. _`*** for withdrawals useDepositAddress:true is a required param do to the current structure of hypercore.`_
