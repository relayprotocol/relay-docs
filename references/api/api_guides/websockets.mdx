...
<Info>
Websockets stream statuses to a connected client. To have Relay push status updates to your backend instead, configure a [webhook](/references/api/api_guides/webhooks).
</Info>
