...
and configure the
[relay solana adapter](/references/relay-kit/sdk/adapters#what-adapters-are-available-out-of-the-box).
To get started, learn how to set up our
[SDK client](/references/relay-kit/sdk/installation). Afterwards, explore our
[getQuote](/references/relay-kit/sdk/actions/getQuote) SDK action to start swapping.
