...
<Info>
  When withdrawing from Solana using the SDK, you will not need to speicify the
...
and configure the
[relay solana adapter](/references/sdk/adapters#what-adapters-are-available-out-of-the-box).
To get started, learn how to set up our
[SDK client](/references/sdk/getting-started). Afterwards, explore our
[getQuote](/references/sdk/actions/getQuote) SDK action to start swapping.
