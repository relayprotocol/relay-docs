...
When a Solana-origin quote is routed through a third-party aggregator and the
generated deposit transaction would exceed 1232 bytes, `POST /quote/v2` returns
