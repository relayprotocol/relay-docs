...
`GET /requests/v2` is **deprecated as of July 22, 2026**. It keeps working, but migrate to `GET /requests/v3` before it's fully retired on **November 22, 2026**.

| Date | What changes |
| --- | --- |
| **Jul 22, 2026** | v2 is deprecated; v3 is the recommended version. v2 keeps working. |
| **Aug 22, 2026 onward** | v2's rate limit is progressively reduced each month; requests over the limit receive `429`. |
| **Nov 22, 2026** | v2 is fully retired — all traffic must be on v3. |
