---
title: "Swapping Integration Guide"
description: "How to integrate Relay for Same and Cross-chain Swaps"
---

This guide shows you how to integrate the Relay API for same-chain and cross-chain swaps.
...
To swap tokens across chains, you need to specify the source and destination chains, currencies, and the amount to swap. Use the [quote endpoint](/references/api/get-quote-v2) to get comprehensive swap quotes that include optimal routing and fee calculations.
