...
To swap tokens across chains, you need to specify the source and destination chains, currencies, and the amount to swap. Use the [quote endpoint](/references/api-v2) to get comprehensive swap quotes that include optimal routing and fee calculations.
