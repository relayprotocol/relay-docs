...
Relay supports depositing and withdrawing to Lighter from any supported chain. To try it today, deposit using the [Relay App](https://relay.link/bridge/lighter) (withdrawing is not yet supported). This document details how to integrate Lighter deposits into your application.
