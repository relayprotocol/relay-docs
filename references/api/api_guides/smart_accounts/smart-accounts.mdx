...
description: "How Relay uses ERC-4337 and EIP-7702 to enable smart wallet features like gas sponsorship, batching, and crosschain execution"
---

Smart accounts unlock new design space in **Relay's crosschain infrastructure**. With them, Relay can:
...
- **Preserve intent and gas delegation across chains**  
  The Relay solver can bridge ETH or tokens to the user's EOA, and the EOA can act as a smart wallet
...
Smart accounts let Relay overcome key limitations in a crosschain solver system:
...
This wasn't previously possible because there was no way to inject logic into EOAs **without deploying a contract**. Now applications can.
...
Reach out to the Relay team to share what you're building.
