...
description: "How to execution cross-chain calls using Relay"
---

You can use Relay cross-chain execution to perform any action (tx) on any chain. This work by specificying the transaction data you wish to execute on the destination chain as part of the initial quoting processes.
    ...
    txs: [
      {
        ...
        data: "0xd0e30db0", // Contract call data
      },
    ],
  }),
});
...
response = requests.post('https://api.relay.link/quote/v2', json={
    'user': '0x03508bb71268bba25ecacc8f620e01866650532c',
    'originChainId': 1,
    'destinationChainId': 8453,
    'originCurrency': '0x0000000000000000000000000000000000000000',
