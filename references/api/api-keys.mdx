...
| `/requests/v3`         | 200 requests per minute |
...
| `/requests`            | 5 requests per second                                                                                       |
...
`/requests` and `/requests/v2` share the 5 rps bucket; `/requests/v3` has its own 20 rps bucket.
