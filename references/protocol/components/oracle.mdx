...
- **Oracle contract** — Part of the [`settlement-protocol`](https://github.com/relayprotocol/relay-settlement) repository, deployed on the [Relay Chain](https://explorer.chain.relay.link).
