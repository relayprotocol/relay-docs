...
The Oracle application is open source in the [`relay-protocol-oracle`](https://github.com/relayprotocol/relay-protocol-oracle) repository. See the [Third-Party Oracle guide](/references/protocol/guides/third-party-oracle) for deployment and operation instructions.
