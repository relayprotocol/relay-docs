...
ERC4626 vault that enables crosschain asset bridging and yield generation
...
_Used to receive crosschain messages_
...
Handles incoming crosschain messages from Hyperlane
