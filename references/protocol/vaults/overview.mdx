...
Vaults are composable, making them easy to integrate with other defi protocols and applications. The Relay team has deployed Vaults initially on Ethereum Mainnet and Arbitrum. Users can interact with Vaults via our [**user interface**](https://relay.link/vaults/) or directly through smart contracts.
...
Explore the Vaults on Ethereum Mainnet and Arbitrum through the [Vaults interface](https://relay.link/vaults/).
