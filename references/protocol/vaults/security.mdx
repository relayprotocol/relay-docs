...
The Relay Vault contracts have been audited by [Spearbit](https://spearbit.com/) and you can find the [audit reports in the Relay Github repo](https://github.com/relayprotocol/relay-vaults/blob/main/docs/README.md).
