...
Inevitably, some orders cannot be filled, and the user needs to be refilled. Relay is designed to make this experience as smooth as possible, with multiple supported pathways, depending on the circumstances:
