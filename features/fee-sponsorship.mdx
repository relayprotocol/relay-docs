...
For more details on the fee structure, see [Platform Fees](/references/api/api_core_concepts/fees).
...
- [Platform Fees](/references/api/api_core_concepts/fees) — Understanding Relay's fee structure
