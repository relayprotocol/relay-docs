...
Fee Sponsorship allows you to cover the transaction fees for your users' Relay transactions. By sponsoring fees, you can eliminate the friction of users needing to pay for gas, creating a seamless experience. This is particularly valuable for onboarding new users or providing a premium experience for your application.
...
2. **Sufficient App Balance** — Your app balance must have enough funds to cover the fees you wish to sponsor.

<Note>
Don't have an API key yet? [Request one here](/api-keys). // @TODO: Add link to api keys page
</Note>

Each API key is associated with a sponsoring wallet address. Once you're set up, you can begin depositing funds and sponsoring transactions.
