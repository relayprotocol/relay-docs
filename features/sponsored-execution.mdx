...
<Steps>
  <Step title="Get a quote">
    This flow assumes that the user is using a smart wallet. Use the [quote endpoint](/references/api/get-quote-v2) to get a quote for the transaction you want to execute.
    <CodeGroup>
     ```bash cURL
...
* If the transaction relies on `tx.origin`, the transaction signer must be a smart wallet (EIP-7702, ERC-4337, etc).