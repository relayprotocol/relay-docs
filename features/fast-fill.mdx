...
4. **Sufficient App Balance** — Your app balance must have enough funds to cover fast fills. Fast fills draw from your app balance and restore it once transactions land onchain. App balance is also used for [fee sponsorship](/features/fee-sponsorship).
