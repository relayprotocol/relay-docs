...
- **Auto-refund to depositor**: When users deposit from wallets they control, pass the origin chain's native-currency address as `refundTo` to refund to the depositor automatically. Use `0x0000000000000000000000000000000000000000` on Ethereum and other EVM chains, `bc1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqmql8k8` on Bitcoin, and `11111111111111111111111111111111` on Solana. Avoid this option when deposits may originate from a centralized exchange.
