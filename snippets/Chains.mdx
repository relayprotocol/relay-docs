...
return `<tr key=${chain.id}>
          <td>
            <div style="display: flex; align-items: center; gap: 8px; text-transform: capitalize;">
              <img class="chain-icon chain-icon-light" src="https://assets.relay.link/icons/square/${chain.id}/light.png" alt="${chain.displayName}" style="width: 20px; height: 20px; border-radius: 4px; flex-shrink: 0; margin: 0;" />
              <img class="chain-icon chain-icon-dark" src="https://assets.relay.link/icons/square/${chain.id}/dark.png" alt="${chain.displayName}" style="width: 20px; height: 20px; border-radius: 4px; flex-shrink: 0; margin: 0;" />
