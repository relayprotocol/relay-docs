...
Relay is a cross-chain payments system that leverages third-party relayers for low-cost, low-latency cross-chain payments. When users wish to make cross-chain actions (bridging, minting, buying, arbitrary executions), they come to agreement with a relayer, who executes their wishes in exchange for payment on the desired chain.
